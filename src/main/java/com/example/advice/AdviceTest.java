...
public class AdviceTest {
    ...
    @Around("execution(* com.example.service.*.many*(..))")
    ...
    @Before("execution(* com.example.service.*.many*(..))")
    ...
    @AfterReturning(pointcut="execution(* com.example.service.*.many*(..))", returning="returnValue")
    ...
    @After("execution(* com.example.service.*.many*(..))")
